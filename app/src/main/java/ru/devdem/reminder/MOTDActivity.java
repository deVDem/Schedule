...
public class MOTDActivity extends AppCompatActivity {
    ...
    public String mTextMOTD = "Новое обновление " + BuildConfig.VERSION_NAME + "!" +
            ...
            "-Показывание завтрашего дня при сортировке по дням\n" +
            "-Уведомление в конце учебного дня не показывает, сколько осталось до конца перемены\n" +
            "-Исправлены ошибки при обновлении расписания уроков" +
